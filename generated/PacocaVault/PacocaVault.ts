...
export class PacocaVault__userInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PacocaVault extends ethereum.SmartContract {
  static bind(address: Address): PacocaVault {
    return new PacocaVault("PacocaVault", address);
  }
  ...
  calculateHarvestPacocaRewards(): BigInt {
    let result = super.call(
      "calculateHarvestPacocaRewards",
      "calculateHarvestPacocaRewards():(uint256)",
      []
    );
  ...
  try_calculateHarvestPacocaRewards(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "calculateHarvestPacocaRewards",
      "calculateHarvestPacocaRewards():(uint256)",
      []
  ...
  calculateTotalPendingPacocaRewards(): BigInt {
    let result = super.call(
      "calculateTotalPendingPacocaRewards",
      "calculateTotalPendingPacocaRewards():(uint256)",
      []
    );
  ...
  try_calculateTotalPendingPacocaRewards(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "calculateTotalPendingPacocaRewards",
      "calculateTotalPendingPacocaRewards():(uint256)",
      []
  ...
  userInfo(param0: Address): PacocaVault__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new PacocaVault__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_userInfo(
    param0: Address
  ): ethereum.CallResult<PacocaVault__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new PacocaVault__userInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
